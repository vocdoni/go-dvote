...
type Signer interface {
	// TODO(demogat): expose Sign, not SignJSON
	// TODO(demogat): the result should be []byte, not string
...
type VochainClient interface {
	// TODO(demogat): do we want a more generic API?
...
type CensusManager interface {
	...
	// TODO(demogat): is this too wide? maybe just URIprefix?
	Data() data.Storage
}
