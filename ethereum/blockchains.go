...
var mainnet = Specs{
	...
	Contracts: map[string]*ethereumhandler.EthereumContract{
		ethereumhandler.ProcessesContractName:         {Domain: types.ProcessesDomain, ListenForEvents: true},
		ethereumhandler.NamespacesContractName:        {Domain: types.NamespacesDomain, ListenForEvents: true},
		ethereumhandler.TokenStorageProofContractName: {Domain: types.ERC20ProofsDomain, ListenForEvents: true},
		ethereumhandler.GenesisContractName:           {Domain: types.GenesisDomain, ListenForEvents: true},
		ethereumhandler.ResultsContractName:           {Domain: types.ResultsDomain, ListenForEvents: true},
		ethereumhandler.EntitiesContractName:          {Domain: types.EntityResolverDomain},
		ethereumhandler.ENSregistryContractName:       {Address: common.HexToAddress("0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e")},
	},
}
...
var xdai = Specs{
	...
	Contracts: map[string]*ethereumhandler.EthereumContract{
		...
		ethereumhandler.ResultsContractName:           {Domain: types.ResultsDomain, ListenForEvents: true},
		ethereumhandler.EntitiesContractName:          {Domain: types.EntityResolverDomain},
		ethereumhandler.ENSregistryContractName:       {Address: common.HexToAddress("0x00cEBf9E1E81D3CC17fbA0a49306EBA77a8F26cD")},
	},
}
...
var xdaistage = Specs{
	...
	NetworkSource: models.SourceNetworkId_POA_XDAI,
	Contracts: map[string]*ethereumhandler.EthereumContract{
		ethereumhandler.ProcessesContractName:         {Domain: types.ProcessesStageDomain, ListenForEvents: true},
		ethereumhandler.NamespacesContractName:        {Domain: types.NamespacesStageDomain, ListenForEvents: true},
		ethereumhandler.TokenStorageProofContractName: {Domain: types.ERC20ProofsStageDomain, ListenForEvents: true},
		ethereumhandler.GenesisContractName:           {Domain: types.GenesisStageDomain, ListenForEvents: true},
		ethereumhandler.ResultsContractName:           {Domain: types.ResultsStageDomain, ListenForEvents: true},
		ethereumhandler.EntitiesContractName:          {Domain: types.EntityResolverStageDomain},
		ethereumhandler.ENSregistryContractName:       {Address: common.HexToAddress("0x693E79F3FD7DC5B3c32D1914E02a932b88397cC7")},
	},
}
...
var rinkeby = Specs{
	...
	Contracts: map[string]*ethereumhandler.EthereumContract{
		ethereumhandler.ProcessesContractName:         {Domain: types.ProcessesDevelopmentDomain, ListenForEvents: true},
		ethereumhandler.NamespacesContractName:        {Domain: types.NamespacesDevelopmentDomain, ListenForEvents: true},
		ethereumhandler.TokenStorageProofContractName: {Domain: types.ERC20ProofsDevelopmentDomain, ListenForEvents: true},
		ethereumhandler.GenesisContractName:           {Domain: types.GenesisDevelopmentDomain, ListenForEvents: true},
		ethereumhandler.ResultsContractName:           {Domain: types.ResultsDevelopmentDomain, ListenForEvents: true},
		ethereumhandler.EntitiesContractName:          {Domain: types.EntityResolverDevelopmentDomain},
		ethereumhandler.ENSregistryContractName:       {Address: common.HexToAddress("0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e")},
	},
}
